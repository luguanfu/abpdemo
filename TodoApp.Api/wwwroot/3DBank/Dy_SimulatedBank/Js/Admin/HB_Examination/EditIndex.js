...
$(document).ready(function () {
    ...
    $("#E_TypeA").on("ifChecked", function (event) {
        $("#longshowId").css('display', 'none');
    });
    $("#E_TypeB").on("ifChecked", function (event) {
        $("#longshowId").css('display', 'block');
    });
...
function EditBtnSubim() {
    ...
    $.ajax({
        ...
        data: {
            "EditE_PId": EditE_PId, "EditP_Name": EditP_Name, "EditTeamId": TeamId, "EditE_Type": EditE_Type,
            "EditE_StartTime": EditE_StartTime, "EditE_EndTime": EditE_EndTime,
