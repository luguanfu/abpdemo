...
function bindIngfo(page) {
    ...
    var QuestonBQName = $("#QuestonBQName").val();
    var PageSize = 10;
    ...
    $.ajax({
        ...
        data: { "QB_Type": QB_Type, "QB_Description": QB_Description, "QB_Kind": QB_Kind, "QuestonBQName": QuestonBQName, "page": page, "PageSize": PageSize },
        success: function (tb) {
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<td><span class="pie">' + data[i]["QuestonBQName"] + '</span></td>';
