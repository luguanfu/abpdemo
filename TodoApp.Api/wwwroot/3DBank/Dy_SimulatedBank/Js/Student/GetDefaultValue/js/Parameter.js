...
function BtnSubim() {
    ...
    $("#Addform").ajaxSubmit({
        type: "post",
        url: '/Parameter/Add?txtIs_System=' + txtIs_System,
...
function GetListById(Id) {
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Parameter/GetListById?Id=' + Id,
        async: false,
        success: function (data) {
            if (data.length > 0) {
...
function EditBtnSubim() {
    ...
    $("#Editform").ajaxSubmit({
        type: "post",
        url: '/Parameter/Edit?Id=' + MId + '&txtIs_System=' + txtIs_System,
...
function GetListByIdTo(Id) {
    $.ajax({
        Type: "post",
        dataType: "json",
        url: '/Parameter/GetListByIdTo?Id=' + Id,
        async: false,
        success: function (data) {
            if (data.length > 0) {
