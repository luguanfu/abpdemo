...
(function (win, doc, _) {
   ...
   function checkTask(element, key) { 
                    ...
                    console.log("任务可以提交");
                     ...
                     if (key.toLowerCase() == 'true') {
                        ...
                        $(".form-item").each(function (i, e) {
                             //取值
                        if ($(e).attr("id").indexOf("check") > -1)
                        { 
                        console.log("7777:" + $(e).attr("id") + ":"  + $(e).is(':checked'));//$('#checkbox-id').attr('checked')
                            if ( $(e).is(':checked'))
                            {
                                 bank.data+="&"+($(e).attr("vtitle")+":"+$(e).attr("id")+"=1");
                            }
                            else
                            {
                                bank.data+="&"+($(e).attr("vtitle")+":"+$(e).attr("id")+"=0");
                            }
                        }
                        else
                        {
    ...
    function checkRegex(element) {
        ...
        console.log('0000:'+$(element).attr("value") +":" + value + ":" + element.hasOwnProperty('value'));
         value = element.value;
