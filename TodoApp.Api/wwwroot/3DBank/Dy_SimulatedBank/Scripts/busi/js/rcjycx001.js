$(document).ready(function () {
 ...
 //         });
    ...
    var planid = getQueryString("planid");
        //冻结止付历史查询回车事件
        var bdFrame = encodeURI("/commontable?fields=lsh|流水号,zh|账号,zhxh|账户序号,hm|户名,bz|币种,jdbz|借贷标志,je|金额,xzbz|现转标志,zy|摘要,khjg|开户机构,pzzl|凭证种类,pzh|凭证号,jyjg|交易机构,gyh|柜员号,zjlx|证件类型,zjhm|证件号码,dsfzh|对手方账号,dsfhm|对手方户名,cxbz|撤销标志&table=tb_daily_rcjycx&orderby=id&page=1&is_page=true");
