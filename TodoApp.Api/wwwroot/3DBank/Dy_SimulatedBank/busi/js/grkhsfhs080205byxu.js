...
var planid=getQueryString("planid");
	//批次号回车事件
	var bdFrame = _ip+"/commontable?fields=pzlx|证件类型,qshm|证件号码,zzhm|有效期类型,pzsl|到期日,id|签发机构&table=tb_daily_voucher&orderby=id&is_page=false&where= and 1!=1&toolbar=true";
